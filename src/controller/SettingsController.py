...
class SettingsController(ObController):
    ...
    def register(self):
        ...
        self._app.add_url_rule('/settings/variable-plugin/list', 'settings_variable_plugin_list', self.settings_variable_plugin_list, methods=['GET'])
        self._app.add_url_rule('/settings/variable-plugin/edit', 'settings_variable_plugin_edit', self.settings_variable_plugin_edit, methods=['POST'])
