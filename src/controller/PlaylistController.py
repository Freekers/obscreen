...
class PlaylistController(ObController):
    ...
    def register(self):
        self._app.add_url_rule('/playlist', 'playlist', self.playlist, methods=['GET'])
        self._app.add_url_rule('/playlist/list/<playlist_id>', 'playlist_list', self.playlist_list, methods=['GET'])
        self._app.add_url_rule('/playlist/add', 'playlist_add', self.playlist_add, methods=['POST'])
        self._app.add_url_rule('/playlist/save', 'playlist_save', self.playlist_save, methods=['POST'])
        self._app.add_url_rule('/playlist/delete/<playlist_id>', 'playlist_delete', self.playlist_delete, methods=['GET'])
        self._app.add_url_rule('/playlist/set-default/<playlist_id>', 'playlist_set_fallback', self.playlist_set_fallback, methods=['GET'])
