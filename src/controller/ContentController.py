...
class ContentController(ObController):
    ...
    def register(self):
        self._app.add_url_rule('/slideshow/content', 'slideshow_content_list', self.slideshow_content_list, methods=['GET'])
        self._app.add_url_rule('/slideshow/content/add', 'slideshow_content_add', self.slideshow_content_add, methods=['GET', 'POST'])
        self._app.add_url_rule('/slideshow/content/edit/<content_id>', 'slideshow_content_edit', self.slideshow_content_edit, methods=['GET'])
        self._app.add_url_rule('/slideshow/content/save/<content_id>', 'slideshow_content_save', self.slideshow_content_save, methods=['POST'])
        self._app.add_url_rule('/slideshow/content/delete', 'slideshow_content_delete', self.slideshow_content_delete, methods=['GET'])
        self._app.add_url_rule('/slideshow/content/rename', 'slideshow_content_rename', self.slideshow_content_rename, methods=['POST'])
        self._app.add_url_rule('/slideshow/content/cd', 'slideshow_content_cd', self.slideshow_content_cd, methods=['GET'])
        self._app.add_url_rule('/slideshow/content/add-folder', 'slideshow_content_folder_add', self.slideshow_content_folder_add, methods=['POST'])
        self._app.add_url_rule('/slideshow/content/move-folder', 'slideshow_content_folder_move', self.slideshow_content_folder_move, methods=['POST'])
        self._app.add_url_rule('/slideshow/content/rename-folder', 'slideshow_content_folder_rename', self.slideshow_content_folder_rename, methods=['POST'])
        self._app.add_url_rule('/slideshow/content/delete-folder', 'slideshow_content_folder_delete', self.slideshow_content_folder_delete, methods=['GET'])
        self._app.add_url_rule('/slideshow/content/show/<content_id>', 'slideshow_content_show', self.slideshow_content_show, methods=['GET'])
        self._app.add_url_rule('/slideshow/content/upload-bulk', 'slideshow_content_upload_bulk', self.slideshow_content_upload_bulk, methods=['POST'])
        self._app.add_url_rule('/slideshow/content/delete-bulk-explr', 'slideshow_content_delete_bulk_explr', self.slideshow_content_delete_bulk_explr, methods=['GET'])
