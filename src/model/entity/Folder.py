...
class Folder:
    ...
    def __init__(self, entity: Union[FolderEntity, str] = FolderEntity.CONTENT, name: str = 'Untitled', parent_id: Optional[int] = None, id: Optional[int] = None, created_by: Optional[str] = None, updated_by: Optional[str] = None, created_at: Optional[int] = None, updated_at: Optional[int] = None):
