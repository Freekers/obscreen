...
class ContentManager(ModelManager):
    ...
    def __init__(self, lang_manager: LangManager, database_manager: DatabaseManager, variable_manager: VariableManager, config_manager: ConfigManager):
        super().__init__(lang_manager, database_manager, variable_manager)
